...
def main(args):
    ...
    ratios = [0.8-args.train_ratio, args.train_ratio, 0.1, 0.1]
    ...
    model.load_state_dict(
        torch.load(args.pretrained_model_path, weights_only=True)
        )
    ...
    optimizer = optimizer_class(train_params, **optimizer_params)
