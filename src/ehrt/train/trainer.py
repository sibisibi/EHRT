...
class Trainer:
    ...
    def train(
        ...
        optimizer_grouped_parameters = [
            {
                "params": [p for n, p in param if p.requires_grad and not any(nd in n for nd in no_decay)], # MODIFIED TO CHECK REQUIRES_GRAD
                "weight_decay": weight_decay,
            },
            {
                "params": [p for n, p in param if p.requires_grad and any(nd in n for nd in no_decay)], # MODIFIED TO CHECK REQUIRES_GRAD
                "weight_decay": 0.0,
            },
        ]
